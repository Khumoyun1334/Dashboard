  ...
  return (
    <div>
      <div className="grid gap-6">
        ...
        <p className="text-sm font-semibold"> Shodow</p>
      </div>
      <div className="py-8 px-8 mt-4 bg-white rounded-lg">
        <p className="text-sm font-semibold"> Basic Shadow</p>
        <div className="grid grid-cols-6 gap-5 md:grid mt-7">
          <div className="shadow-md grid justify-center items-center p-4 hover:shadow-none duration-500 pt-8 rounded-xl text-center">
          ...
          <div className="shadow-lg grid justify-center items-center p-4 hover:shadow-none duration-500 pt-8 rounded-xl text-center">
            <p className="text-xs">boxShadow</p>
          ...
          <div className="shadow-2xl grid justify-center items-center p-4 hover:shadow-none duration-500 pt-8 rounded-xl text-center">
            <p className="text-xs">boxShadow</p>
      ...
      <div className="bg-white mt-8 py-8 px-8">
        ...
        <div className="shadow-xl grid justify-start w-[160px] items-center p-4 hover:shadow-none duration-500 pt-8 rounded-xl text-center pl-10">
          <p className="text-xs text-center py-2 pl-8"> z1</p>
        </div>
      </div>
    </div>
  );
